...
namespace Restoran.Migrations
{
    ...
    [Migration("20180917072710_DeleteDateFromOrderController")]
    partial class DeleteDateFromOrderController
    {
            ...
            modelBuilder.Entity("Restoran.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Date = new DateTime(2015, 7, 25, 12, 30, 33, 0, DateTimeKind.Unspecified), DishId = 1, InstitutionId = 1 },
                        new { Id = 2, Date = new DateTime(2015, 8, 25, 12, 35, 33, 0, DateTimeKind.Unspecified), DishId = 3, InstitutionId = 2 }
                    );
                });
